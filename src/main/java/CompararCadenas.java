public class CompararCadenas {
    ...
    public static void main(String[] args) {
        String s1 = new String("hola"); //"s1 es una copa de hola";
        String s2 = "adios";
        ...
        //prueba la igualdad (ignora el uso de mayusculas/minusculas
        if(s3.equalsIgnoreCase(s4))//true
            System.out.printf("%s es igual a %s si se ignora el uso de mayusculas/minusculas",s3,s4);
        else
            System.out.printf("s3 no es igual a s4");
        ...
        System.out.printf("\ns4.compareTo(s3) es %d",s4.compareTo(s3));
        ...
        //prueba con regionMatches (ignora el uso de mayusculas/minusculas
